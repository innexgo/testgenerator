...
const listStyle = { /*every feature listed*/
  width: '60%',
  marginLeft: '8%', /*also used in the first marginRight for the pricing table*/
  display: 'fixed'
};

const featuresTable = { /*formerly tabStyle, each table uses this styling*/
  margin: '-1%', 
  width: '140%'
}
...
function Features() {
  return(
    <div style={{backgroundColor: '#f2f3f4'}}>
      <ExternalLayout>
          <h1 style={{textAlign: 'center', marginBottom: '2%'}}>Features</h1>
